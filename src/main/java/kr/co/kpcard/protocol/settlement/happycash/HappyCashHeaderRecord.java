...
public class HappyCashHeaderRecord implements RecordInterface {
	...
	protected final static int LEN_FILLER 			= LEN_SIZE - LEN_DIVIDER - LEN_CREATE_DATE - LEN_SEND_DATE;
	...
	public HappyCashHeaderRecord() {
	}

	public HappyCashHeaderRecord(String divider, String createDate, String sendDate, String filler) {
