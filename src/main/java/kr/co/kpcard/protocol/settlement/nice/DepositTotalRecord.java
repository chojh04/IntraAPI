...
public class DepositTotalRecord implements RecordInterface {
	...
	protected final static int LEN_ACCOUNT_NO = 20;
	protected final static int LEN_FILLER = 29;
	
	private String divider; // 레코드 구분 : 2 ("53")
	private String receiptCount;; // 접수 건수 : 6 
	private String receiptAmount; //접수 금액 : 12 
	private String returnCount; // 반송 건수 : 6 
	private String returnAmount; // 반송 금액 : 12 
	private String deferCount; // 보류 건수 : 6 
	private String deferAmount; // 보류 금액 : 12 
	private String deferClearCount; // 보류해제 건수 : 6 
	private String deferClearAmount; // 보류 해제 금액 : 12 
	private String totalCount; // 합계 건수 : 6 
	private String totalAmount; // 합계 금액 : 12 
	private String totalVat; // 수수료 합계 : 12 
	private String depositAmount; // 입금액 : 12 
	private String accountNo; // 결제 계좌번호 : 20 
	private String filler; // filler : 29 
	...
	public boolean pasre(byte[] record)
	{
		...
		try 
		{
			...
			this.accountNo = StringUtil.copyToString(record
					...
					+ LEN_RETURN_COUNT + LEN_RETURN_AMOUNT + LEN_DEFER_COUNT
					+ LEN_DEFER_AMOUNT + LEN_DEFER_CLEAR_COUNT + LEN_DEFER_CLEAR_AMOUNT
					+ LEN_TOTAL_COUNT + LEN_TOTAL_AMOUNT + LEN_TOTAL_VAT + LEN_DEPOSIT_AMOUNT
					, LEN_ACCOUNT_NO);
