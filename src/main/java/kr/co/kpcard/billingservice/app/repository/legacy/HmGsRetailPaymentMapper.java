...
public interface HmGsRetailPaymentMapper 
{
	/*
	...
	*/
	...
	public static final String INSERT_PAYMENT_SQL = "INSERT INTO HAPPY_MISC.GSRETAIL_PAYMENT "
												  + "("
	...
	public static final String DELETE_PAYMENT_SQL = "DELETE FROM HAPPY_MISC.GSRETAIL_PAYMENT WHERE CUR_DATE BETWEEN #{currentStartDate} AND #{currentEndDate} AND MERCHANT_ID = #{merchantId}";
	
	public static final String SELECT_PAYMENT_SQL = "SELECT * FROM HAPPY_MISC.GSRETAIL_PAYMENT WHERE CUR_DATE BETWEEN #{currentStartDate} AND #{currentEndDate} AND MERCHANT_ID = #{merchantId}";
	
	@Resource(name="legacyDataSource")
	@Insert(INSERT_PAYMENT_SQL)	
	public int insertHmPaymentRecord(HmGsRetailPayment hmGsRetailPayment);
	
	@Resource(name="legacyDataSource")
	@Delete(DELETE_PAYMENT_SQL)
	public int deleteDailyHmPaymentRecord(@Param(value="currentStartDate") String currentStartDate,
	...
	public List<HmGsRetailPayment> selectHmPaymentRecord(@Param(value="currentStartDate") String currentStartDate,
														 @Param(value="currentEndDate") String currentEndDate,
														 @Param(value="merchantId") String merchantId);
