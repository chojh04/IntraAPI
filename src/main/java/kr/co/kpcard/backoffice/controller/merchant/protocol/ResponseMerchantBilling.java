...
@Getter
@Setter
public class ResponseMerchantBilling {
	...
	public void setValues(String serviceBillingId, String serviceId,
			...
			String aplEndDt, String expectedMerchantCommision, String billingCommType, String billingCommTypeName) {
		...
		this.billingCommTypeName = billingCommTypeName;
	}
